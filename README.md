...
- "Using these files (provide the chat with the files in \templates) please create modular documentation for the app we've been discussing in this chat" Works in chat interfaces like grok.com
