...
Live files under `docs/` are **fill-in blanks**. Teaching, examples, and “how to write this” live here in `help/` (humans) and in [`../agent/workflow/`](../agent/workflow/README.md) (agents). Do not copy sermons into a live Understanding, spec, or TODO.
