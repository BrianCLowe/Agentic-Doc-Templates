...
| `Product_Vision_Template.md` | `docs/Product-Vision.md` — create if missing **and** profile is `prevent` (or unset) / `balanced` with 2+ feature stems; **do not** create on `ship-first` | `content-templates` **and** profile says so |
