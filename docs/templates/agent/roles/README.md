...
- Harness adapters are **generated** from [`adapter-src/`](adapter-src/README.md) (`python3 docs/templates/agent/scripts/gen_role_adapters.py`) — do not hand-edit `cursor/` or `grok/`.
