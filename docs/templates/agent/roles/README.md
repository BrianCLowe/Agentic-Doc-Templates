...
| **Todo warden** | [`todo-warden.md`](todo-warden.md) | Post-loop **docs-only** honesty + **hygiene**: reopen overclaims, cited gap TODOs (hard caps; at most one §5.4 research item), **move** finished `[x]` into Completed | Report clean / gaps-found — **no code**; hygiene-only stays **clean** |
