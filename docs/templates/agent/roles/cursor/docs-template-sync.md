...
- When catch-up includes **2.7.27** and reshape executes: **instruction-footer strip** — delete copied sermons / long Instructions / inline section essays from live Understanding / spec / TODO; keep user fill-in; leave SCAFFOLDS + playbook pointer. `master-index` adopts slimmer At a Glance
