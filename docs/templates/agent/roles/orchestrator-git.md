...
| cwd is a **linked / host worktree** (`branch_origin: host-worktree` or `platform` on Cloud) | **Do not** checkout default **in this tree**. One line: *session is a host worktree; left it as-is*. |
