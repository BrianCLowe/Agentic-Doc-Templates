...
- When catch-up includes **2.7.27** and reshape executes: **instruction-footer strip** — delete copied sermons / long Instructions from live Understanding / spec / TODO; keep user fill-in; leave SCAFFOLDS + playbook pointer
