...
7. If `docs/Product-Vision.md` exists and is **confirmed**, do not implement a feature that fights that end-state picture (Workflow §4.5). Under **prevent**, draft it if missing. Do not silent-create on **ship-first**.
