...
| todo warden / reconcile TODOs vs implementation / TODO honesty after orchestration | see **Optional subagents** → else `docs/templates/agent/roles/todo-warden.md` |
...
| todo warden / reconcile TODOs / TODO honesty / gaps after orchestration | `todo-warden.md` | `docs/templates/agent/roles/todo-warden.md` |
