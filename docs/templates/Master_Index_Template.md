...
**Template version**: 2.6.3 *(update when syncing from `templates/Master_Index_Template.md`)*
**Workflow version**: 2.6.3 *(must match `templates/agent/Modular_Docs_Workflow.md` — update both on sync)*
