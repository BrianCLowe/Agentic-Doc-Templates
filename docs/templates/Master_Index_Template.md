...
| **Docs freshness** | Once per session: `git status` + `git worktree list` before treating Master Index / TODOs as current. Sibling `docs/` drift → stop. [§0.3](templates/agent/workflow/session-freshness.md) |
